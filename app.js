        ...
        .then(data => {
            ...
            if (data.objects.length) {
                ...
                data.objects.forEach(object => {
                    html += `
                        <li>
                        <a href="http://localhost:3000/fetch-image?f=${object.Key}">${object.Key}</a>
                        resize: 
                        <a href="http://localhost:3000/resize-image?f=${object.Key}&h=100&w=100">100x100</a>
                        <a href="http://localhost:3000/resize-image?f=${object.Key}&h=200&w=200">200x200</a>
                        <a href="http://localhost:3000/resize-image?f=${object.Key}&h=1000&w=1000">1000x1000</a>
                        <a href="http://localhost:3000/delete-image?f=${object.Key}">delete</a>
                        </li>
                    `;
                    }
                );
                ...
                html += `
                    ...
                    <a href="http://localhost:3000/zip">Zip them!</a>
                    `;
            } else {
                html +=  `nope :(`;
            }
